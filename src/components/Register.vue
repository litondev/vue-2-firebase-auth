  ...
  <div class="row justify-content-center">
   <div class="col-md-8">
    <div class="card">
     ...
     <div class="card-body">
      <div v-if="error" classs="alert alert-danger">{{error}}</div>
      ...
      <form action="#" @submit.prevent="submit">
       <div class="form-group row">
        ...
        <div class="form-group row">
         <label for="email" class="col-md-4 col-fomr-label text-md-right">Email</label>
         <div class="col-md-6">
...
export default {
 ...
 methods: {
  submit(){
   ...
   .then(data => {
    data.user.updateProfil({
     dispayName : this.form.name
    }).then(() => {});
   })
   .catch(err => {
